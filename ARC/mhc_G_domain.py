"""
.. module:: mhc_G_domain
    :synopsis: Obtains the G-domain (peptide binding groove domain) of an MHC sequence.
.. moduleauthor:: Swapnil Mahajan, Austin Crinklaw
"""
...
class mhc_G_domain:
    ...
    def get_domain(self, blastout):
        ...
        for i in range(df.shape[0]):
            hit_cover = (df.loc[i, "send"] - df.loc[i, "sstart"] + 1) / df.loc[
                i, "slen"
            ]
    ...
    def check_b2m(self, seqfile):
        ...
        blout = self.run_blast(seqfile, b2m_db, blout_file.name, "90", pow(10, -50))
